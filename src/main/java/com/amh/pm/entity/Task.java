...
public class Task {
	...
	public Task(String title, String summary, Date scheduleStartDate, Date scheduleEndDate, Date actualStartDate,
			Date actualEndDate, String weight, String score, Project project, User assignee) {
		super();
	...
	public boolean equals(Object obj) {
		...
		return task.getTitle() == this.getTitle() && task.getSummary() == this.getSummary()
				...
				&& task.getActualEndDate() == this.getActualEndDate() && task.getStatus() == this.getStatus()
				&& task.getWeight() == this.getWeight() && task.getAssignee() == this.getAssignee();
	}
